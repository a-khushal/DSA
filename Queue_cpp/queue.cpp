...
// why use liked lists: cuz in arr if we declare it's size as 100 and store 5 elements in queue then remaining momory goes wasted also arr is fixed in size, we need to increase the size of arr if queue size is bigger than the size of arr.
